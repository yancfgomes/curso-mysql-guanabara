...
select * from cursos order by nome; -- ou ~order by nome asc;
...
select * from cursos where ano ='2016' order by nome; -- operadores relacionais: = / > / < / >= / <= / != ou <> / between <valor1> and <valor2> / in (<valor1>,<valor2>,<valor3>) / and / or
